...
function get_jumlah($tgl) {
  global $konek;
  $q = mysqli_query($konek, "SELECT * FROM pembelian WHERE tanggal LIKE '%$tgl%'");
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pembelian Tanggal</h3>
              </div>
              <div class="card-body">
                <div class="chart">
...
<script>
  $(function () {
    ...
    var areaChartData = {
      ...
      <?php 
      for($i = 0; $i < 31; $i++) {
        echo "'".date('d M Y', time()-60*60*24*30*$i)."', ";
      }
      ?>
      ],
      datasets: [
        {
          label               : 'Pembelian Tanggal',
          ...
          data                : [
            <?php 
            for($i = 0; $i < 31; $i++) {
              echo get_jumlah(date('d M Y', time()-60*60*24*30*$i)).", ";
            }
            ?>
          ]
        },
