...
function get_jumlah($tahun) {
  global $konek;
  $q = mysqli_query($konek, "SELECT * FROM pembelian WHERE priode LIKE '%$tahun%'");
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Pembelian Tahunan</h3>
              </div>
              <div class="card-body">
                <div class="chart">
